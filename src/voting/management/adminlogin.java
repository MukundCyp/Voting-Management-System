...
public class adminlogin extends javax.swing.JFrame {
    ...
    private void jvloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jvloginActionPerformed
        ...
        try {
            ...
            ps1.setString(2, (AES.encrypt(String.valueOf(jvoterpassword.getPassword()), "hello")));
            ResultSet result = ps1.executeQuery();
            if (result.next()) {
                JOptionPane.showMessageDialog(null, "Username and Password correct");
                ResultSet rs = stmt.executeQuery("SELECT * from votingrecord where voting_status = 1 and voter_id = '"+ jvoterid.getText()+"'");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(null, "VOTER HAVE ALREADY VOTED !!!");
                    adminlogin h = new adminlogin();
                    h.setVisible(true);
                    dispose();
                } else {
                    int id = Integer.parseInt(jvoterid.getText());
                    Recognizer s = new Recognizer(id);
                    s.setVisible(true);
                    dispose();
                }
            } else {
